      ...
      >
        ...
        >
          ...
          <span
            ...
            <router-link  class="flex items-center p-4 hover:bg-indigo-500 hover:text-white " :to="{name:'dashboard'}">
            <span class="mr-2">
                <svg
                fill="none"
                stroke="currentColor"
          ...
          >
          <span>
            <router-link  class="flex items-center p-4 hover:bg-indigo-500 hover:text-white " :to="{name:'deliveryBoy'}">
            <span class="mr-2">
          ...
          <span @click="isOpen = false" class="flex items-center p-4 hover:bg-indigo-500 hover:text-white ">
            <router-link  class="flex items-center p-4 hover:bg-indigo-500 hover:text-white " :to="{name:'orderManager'}">
            <span class="mr-2">
          ...
          <span @click="isOpen = false" class="flex items-center p-4 hover:bg-indigo-500 hover:text-white ">
            <router-link  class="flex items-center p-4 hover:bg-indigo-500 hover:text-white " :to="{name:'user'}">
            <span class="mr-2">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                viewBox="0 0 24 24" class="w-6 h-6">
