<template>
  <div class="md:px-8  lg:w-10/12 md:10/12 w-full md:m-auto  md:p-0 p-3 md:mt-20">
    <div v-if="showAler"
      class="bg-green-100 rounded-lg py-4 border px-6 mb-4 text-base text-green-700 absolute w-2/5 right-0 z-40"
      role="alert">
      Your successed
    </div>
    <div class="main">
      ...
      <div class="grid grid-cols-12 gap-4 px-3">
          ...
          <div class="" v-if="order.price">
            ...
            <div class="enter Details">
              ...
              <div class="">
                ...
                <textarea v-model="order.information" class="input border py-2 w-full mb-3 " cols="30"
                  rows="10"></textarea>
        ...
        <div class="col-span-8">
          <Map :disableUI="false" :zoom="12" mapType="hybrid" @distance="distance"
            :center="{ lat: 38.8977859, lng: -77.0057621 }" :originLat="originLat" :originLng="originLng"
            :destinationLat="destinationLat" :destinationLng="destinationLng"></Map>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg relative w-auto pointer-events-none">
          <div
            ...
            <div class="modal-body relative p-4">
              ...
              <SelectVehehileTypeModel @selectedVehile="selectVehile" :weight="order.weight" :material="order.material" :setDistance="setDistance" />
            </div>
          </div>
        </div>
      </div>
