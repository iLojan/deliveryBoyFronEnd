  ...
  <div style="font-size: 14px;">
    <div :style="divStyle" id="divpdf">
      <div :style="pageStyle" id="pdfpreview">
        <div class="" style="display: flex;padding-left: 30px;padding-right: 30px;padding-bottom: 20px;margin-top: 19px;">
        <div style="
        align-items: center;
        display: flex;
        font-weight: 500;
    ...
    ">K</div>
        <div class="" style="width: 95%;">
          <div :style="headerStyle" id="resume11">
            <div :style="bodyStyle1">
              <div style="" :style="bodyStyle1">
...
15Cook Lane,Scarsdale,NY 107050 / C:0758907249 / Jone@gmail.com
        ...
        <div class="" :style="bodyStyle">
          <div class="" style="padding:10px;background-color:rgb(51 73 118);color: #fff;margin-bottom: 15px;">
         
            <div class="" style="text-align: center;">Software Engineer</div>
           </div>
        ...
        <div class="" :style="bodyStyle">
          ...
          <div class="" style="padding-bottom: 25px;">
            <div class="" style="display: flex;">
              <div class="" style="width: 100%;">
                <div class="" style="padding-bottom: 5px;text-align: left;margin-bottom: 4px;">ABC Lanka(PVT) Ltd  <span class="" style="padding-left: 10px;">08/2017 - 05/2021</span></div>
          ...
          <div class="" style="padding-bottom: 14px;">
            <div class="" style="display: flex;">
              <div class="" style="width: 100%;">
                <div class="" style="padding-bottom: 5px;text-align: left;margin-bottom: 4px;">ZXC Corners Lanka(PVT) Ltd  <span class="" style="padding-left: 10px;">08/2017 - 05/2021</span></div>
        ...
        <div class="" :style="bodyStyle">
          ...
          <div class="" style="padding-bottom: 14px;">
            <div class="" style="display: flex;">
              <div class="" style="width: 100%;">
                <div class="" style="padding-bottom: 5px;text-align: left;margin-bottom: 4px;">Ranabima Royal Coleege , BCA<span> <strong>GPA</strong> 83.3  </span>  <span class="" style="padding-left: 10px;">08/2017 - 05/2021</span></div>
        ...
        <!--  -->
             ...
             <div class="" :style="bodyStyle">
              ...
              <div class="" style="padding-bottom: 14px;">
                <div class="" style="display: flex;">
                  <div class="" style="width: 100%;">
                    <div class="" style="padding-bottom: 5px;text-align: center;">English</div>
                  </div>
                </div>
                <div class="c" :style="paragraph">
                  This is currently blocking Dev and QA Environments.
              ...
              <div class="" style="padding-bottom: 14px;">
                <div class="" style="display: flex;">
                  <div class="" style="width: 100%;">
                    <div class="" style="padding-bottom: 5px;text-align: center">Tamil</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="" :style="bodyStyle">
          ...
          <div class="" style="padding-bottom: 14px;">
            <div class="" style="display: flex;">
              <div class="" style="width: 100%;">
                <div class="" style="padding-bottom: 5px;text-align: left;margin-bottom: 4px;">Certificates , BCA <span class="" style="padding-left: 10px;">08/2017 - 05/2021</span></div>
        ...
        <!--  -->
            ...
            <div class="" :style="bodyStyle">
              ...
              <div class="" style="padding-bottom: 14px;">
                <div class="" style="display: flex;">
                  <div class="" style="width: 100%;">
                    <div class="" style="padding-bottom: 5px;text-align: center;">sparkle
            ...
            <div class="" :style="bodyStyle">
              ...
              <div class="" style="padding-bottom: 14px;">
                <div class="" style="display: flex;">
                  <div class="" style="width: 100%;">
                    <div class="" style="padding-bottom: 5px;text-align: left;margin-bottom: 4px;">Project <span class="" style="padding-left: 10px;">08/2017 - 05/2021</span></div>
            ...
            <div class="" :style="bodyStyle">
              ...
              <div class="" style="padding-bottom: 14px;">
                <div class="" style="display: flex;">
                  <div class="" style="width: 100%;">
                    <div class="" style="padding-bottom: 5px;text-align: left;margin-bottom: 4px;">Courses <span class="" style="padding-left: 10px;">08/2017 - 05/2021</span></div>
            ...
            <!--  -->
              ...
              <div class="" :style="bodyStyle">
                ...
                <div class="" style="padding-bottom: 14px;">
                  <div class="" style="display: flex;">
                    <div class="" style="width: 100%;">
                      <div class="" style="padding-bottom: 5px;text-align: left;margin-bottom: 4px;">Enter award name <span class="" style="padding-left: 10px;">08/2017 - 05/2021</span></div>
              ...
              <!--  -->
                ...
                <div class="" :style="bodyStyle">
                  ...
                  <div class="" style="padding-bottom: 14px;">
                    <div class="" style="display: flex;">
                      <div class="" style="width: 100%;">
                        <div class="" style="padding-bottom: 5px;"> Skill Catogory Name </div>
                      </div>
                    </div>
                    <div class="c">
                ...
                <div class="" style="padding-bottom: 14px;">
                  <div class="" style="display: flex;">
                    <div class="" style="width: 50%;">
                      <div class="" style="padding-bottom: 5px;"> <strong>MR.M.M.M.Sukry</strong>  Senior ICT Instuctor, National Vocational Training Institute-vantharumoolai VTA-Batticaloa </div>
                      <div class="" style="font-weight: 600;font-size: 13px;color: black;">Enter Issuer</div>
                      <div class="" style="display: block;">https://award.com</div>
                    </div>
      ...
      return {
       ...
       marginTop:"3px",
        ...
        sectionTitleStyle: {
          ...
          borderTop: "solid rgb(51 73 118) 4px",
          textAlign: "center",
          padding: "5px",
          paddingBottom: '3px',
          marginBottom: '24px'
