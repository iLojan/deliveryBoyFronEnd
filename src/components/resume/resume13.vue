    ...
    <div :style="divStyle" id="divpdf">
      <div :style="pageStyle" id="pdfpreview">
        <div :style="headerStyle" id="resume6">
          <div :style="bodyStyle">
            <div style=" padding-left: 15px; padding-right: 150px" :style="bodyStyle">
        ...
        <div class="" :style="bodyStyle">
          ...
          <div class="" style="padding-bottom: 14px;">
            <div class="" style="display: flex;">
              <div class="" style="width: 70%;">
                <div class="" style="padding-bottom: 5px; color: #E5A052">ABC Lanka(PVT) Ltd</div>
              ...
              <div class="" style="width: 30%;text-align: right;">
                <div class="" style=" color: #E5A052">08/2017 - 05/2021</div>
              </div>
            </div>
          ...
          <div class="" style="padding-bottom: 14px;">
            <div class="" style="display: flex;">
              <div class="" style="width: 70%;">
                <div class="" style="padding-bottom: 3px;color: #E5A052">ZXC Corners Lanka(PVT) Ltd</div>
                <div class="" style="font-weight: 600;font-size: 13px;color: black;">Associate Software Engineer(Colombo
                  ,
                  Sri Lanka)</div>
              </div>
        ...
        <div class="" :style="bodyStyle">
          ...
          <div class="" style="padding-bottom: 14px;">
            <div class="" style="display: flex;">
              <div class="" style="width: 70%;">
                <div class="" style="padding-bottom: 5px;color: #E5A052">Ranabima Royal Coleege , BCA<span> <strong>GPA</strong> 83.3  </span></div>
        ...
        <!--  -->
             ...
             <div class="" :style="bodyStyle">
              ...
              <div class="" style="padding-bottom: 14px;">
                <div class="" style="display: flex;">
                  <div class="" style="width: 100%;">
                    <div class="" style="padding-bottom: 5px;color: #E5A052">English</div>
                  </div>
                </div>
                <div class="c" :style="paragraph">
                  This is currently blocking Dev and QA Environments.
              ...
              <div class="" style="padding-bottom: 14px;">
                <div class="" style="display: flex;">
                  <div class="" style="width: 70%;">
                    <div class="" style="padding-bottom: 5px;color: #E5A052">Tamil</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="" :style="bodyStyle">
          ...
          <div class="" style="padding-bottom: 14px;">
            <div class="" style="display: flex;">
              <div class="" style="width: 70%;">
                <div class="" style="padding-bottom: 5px;color: #E5A052">ICT NVQ Level 5(diploma)<span> <strong>GPA</strong> 83.3  </span></div>
        ...
        <!--  -->
            ...
            <div class="" :style="bodyStyle">
              ...
              <div class="" style="padding-bottom: 14px;">
                <div class="" style="display: flex;">
                  <div class="" style="width: 100%;">
                    <div class="" style="padding-bottom: 5px;color: #E5A052">sparkle
            ...
            <div class="" :style="bodyStyle">
              ...
              <div class="" style="padding-bottom: 14px;">
                <div class="" style="display: flex;">
                  <div class="" style="width: 70%;">
                    <div class="" style="padding-bottom: 5px;color: #E5A052">ICT NVQ Level 5(diploma)<span> <strong>GPA</strong> 83.3 </span>
                    </div>
            ...
            <!--  -->
              ...
              <div class="" :style="bodyStyle">
                ...
                <div class="" style="padding-bottom: 14px;">
                  <div class="" style="display: flex;">
                    <div class="" style="width: 70%;">
                      <div class="" style="padding-bottom: 5px;color: #E5A052"> Enter award name </div>
                    ...
                    <div class="" style="width: 30%;text-align: right;">
                      <div class="" style="color: #E5A052">08/2017 </div>
                    </div>
                  </div>
                  <div class="c" :style="paragraph">
                    This is currently blocking Dev and QA Environments.
              ...
              <!--  -->
                ...
                <div class="" :style="bodyStyle">
                  ...
                  <div class="" style="padding-bottom: 14px;">
                    <div class="" style="display: flex;">
                      <div class="" style="width: 100%;">
                        <div class="" style="padding-bottom: 5px;color: #E5A052"> Skill Catogory Name </div>
                      </div>
                    </div>
                    <div class="c">
